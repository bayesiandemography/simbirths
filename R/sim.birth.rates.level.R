...
#' Simulated data on age-specific birth rates, with level perturbed.
#'
...
#' with the same age-profile as other region-time combinations,
#' but a level 20 percent higher.
#'

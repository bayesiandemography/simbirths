...
#' Simulated data on age-specific birth counts, with distribution perturbed.
#'
...
#' \code{\link{sim.birth.rates.distn}} multiplied by
...
#' than 30, see \code{\link{sim.birth.counts.distn}}.
"sim.birth.counts.distn.small"
